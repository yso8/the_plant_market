...
from store.views import index, product_detail, add_to_cart, cart, delete_cart, index_add_to_cart, delete_product_to_cart, add_to_favorite, select_delivery_method, payment_method,filter_products, show_favorite
...
urlpatterns = [
    ...
    path('products-filter/<str:name>', filter_products, name="product_filters"),
